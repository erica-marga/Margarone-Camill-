...
<div class="container">
	...
	<!-- indicatori -->
		...
		<div class="item active"><img src="img/cagliari2.jpg"/> </div>
			<div class="item"><img src="img/cagliari3.jpg"/> </div>
			<div class="item"><img src="img/cagliari4.jpg"/> </div>
		</div> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">
		<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-s1-g187881-d238778-Reviews-Hotel_Residence_Ulivi_e_Palme-Cagliari_Province_of_Cagliari_Sardinia.html"><b><i>Hotel Residence Ulivi e Palme</i></b> -  Via Pietro Bembo, 25, 09131 Cagliari</a></p>
			<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color=blu:"></span> 070 485861- <span class="glyphicon glyphicon-envelope" style="color:orange"></span> hotelresidence@uliviepalme.it </p>		
			<hr>
		...
		<h1 id="promozione" class="text-center">Il prezzo include:</h1>
			...
			<p><b> Volo:</b>
				<div id="info"> 
				  ...
				  <tbody>
					<tr>
					  <th scope="row">Milano Malpensa (MPX)- Cagliari (CAG)</th>
					  <td>225€</td>
					  <td>350€</td>
					</tr>
					<tr>
					  <th scope="row">Roma (FCO)- Cagliari (CAG)</th>
					  <td>395€</td>
					  <td>260€</td>
					</tr>
				  </tbody>
				</table>
				<p id="info" class="text-left">Operato da:<b> Volotea</b></p>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=116" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
