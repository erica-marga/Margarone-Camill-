...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/green.jpeg"/> </div>
			<div class="item"><img src="img/green2.jpeg"/> </div>
			<div class="item"><img src="img/green3.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">
		<p id="promozione" class="text-center"><b><i>Il Bramito del Cervo </i></b>- Loc. Zaluna, 2 Zaluna 38037 Predazzo IT</p>
		<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span>  0439 768731 </p>
			<div class="col-sx-12">	
				<p id="info" class="text-justify">Costruzione in tipico stile montano, nel cuore delle Dolomiti, l'albergo Zaluna è ideale per chi vuole trascorrere un periodo di vacanza piacevole e rilassante a contatto con il verde della natura e dei boschi nei quali è immerso. La gestione, curata direttamente dai proprietari, offre un ambiente accogliente e familiare ed una cucina particolarmente curata. La sua posizione in un luogo tranquillo fuori dal centro abitato ne fa comodo punto di partenza per escursioni in montagna e per il raggiungimento degli impianti di sci.</p> 
			</div>
		<p id="promozione" class="text-center">Il prezzo include:</p>
		<p id="info" class="text-justify"><span class="glyphicon glyphicon-bed"></span> 2 notti in hotel con:
		<ul>
		<li> notte e colazione o mezza pensione;</li>
		<li>Sabato attività al Parco Naturale di Paneveggio a partire dalle ore 15.00 per ascoltare il bramito del cervo, laboratori, presentazioni e brevi escursioni anche in notturna;</li>
		<li> Venerdì pomeriggio a Bellamonte in compagnia del Nonno Gustavo che ci accoglierà nel suo “tabià”, un museo dove conoscere e rivivere il mondo dei nostri nonni;</li>
		<li> Visita alla Magnifica Comunità o al Museo Geologico delle Dolomiti.</li>
		<br>
		<li> <b>Servizi opzionali con supplemento:</b></li>
		<ul>
		<li>Transfer per l’escursione</li>
		</ul>
		</ul>
<br>
		<p id="info" class="text-left"><b> Servizi:</b></p>
		<br>
...
<div class="jumbotron">
	<div class="container">
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=121" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
