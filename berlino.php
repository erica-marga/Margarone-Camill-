...
<div class="col-sm-12">
	<h1 id="presentazione" class="text-center">Berlino a soli 350,00€ a persona
...
<div class="container">
	...
	<div class="carousel-inner">
			<div class="item active"><img src="img/berlino2.jpg"/> </div>
			<div class="item"><img src="img/berlino3.jpg"/> </div>
			<div class="item"><img src="img/berlino4.jpg"/> </div>
	</div> 
...
<div class="col-sm-12">
<div id="container">
	<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-g187323-d190694-Reviews-Hotel_Adlon_Kempinski-Berlin.html"><b><i>Hotel Adlon</i></b> - Unter den Linden 77, 10117 Berlin, Germania</a></p>
			<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +49 30 22610 <span class="glyphicon glyphicon-envelope" style="color:orange"></span>sunshinehotel@gmail.com</p>
	...
	<h1 id="promozione" class="text-center">Il prezzo include:</h1>
			...
			<p><b> Volo:</b>
				...
				<p id="info">Operato da: <b>Airberlin</b></p>
				<p><span class="glyphicon glyphicon-plane"></span> Ritorno:</p>
				<p id="info">lun 25 sett. Berlino (TXL)</p>
				<p id="info">Operato da:<b> Airberlin</b></p>
...
<div class="jumbotron">
	<div class="container">
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=118" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
</div>
