...
<div class="jumbotron">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/barcellona.jpg"/> </div>
			<div class="item"><img src="img/barcellona3.jpg"/> </div>
			<div class="item"><img src="img/barcellona4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">
		<p id="promozione" class="text-center"> <b><i>Crowne Plaza Barcelona - Fira Center </i></b></p>
		<p id="promozione" class="text-center">Avenida de Rius I Taulet, 1-3, 08004 Barcellona, Spagna</p>
		<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +39 800 871 698 </p>
		<br>
		<div class="col-sx-12">
		<p id="info" class="text-justify">Situato a 200 m dalla Fontana Magica di Barcellona, l'elegante Crowne Plaza Barcelona - Fira Center offre camere spaziose con TV a schermo piatto e doccia idromassaggio. Facilmente raggiungibile in autobus o in metropolitana dal centro storico di Barcellona, l'hotel dista 500 m dalle stazioni della metropolitana Poble Sec ed Espanya e 200 m dal Poble Espanyol e dalla Fondazione Joan Miró. </p>
		</div>
...
<div class="jumbotron">
	<div class="container">
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=105" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
