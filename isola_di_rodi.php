...
<div class="col-sm-12">
	<h1 id="presentazione" class="text-center">Isola di Rodi a soli 350,00€ a persona;
...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			<div class="item active"><img src="img/rodi2.jpg"/> </div>
			<div class="item"><img src="img/rodi3.jpg"/> </div>
			<div class="item"><img src="img/rodi4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="col-sm-12">
<div id="container">
	<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-g635613-d271726-Reviews-Sheraton_Rhodes_Resort-Rhodes_Town_Rhodes_Dodecanese_South_Aegean.html"><b><i>Sheraton Rhodes Resort </i></b>- Ialyssos Avenue, Rhodes 85100, Grecia</a></p>
	<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +30 2241 075000 </p>
	...
	<table class="table table-inverse">
	  ...
	  <tbody>
		<tr>
		  <th scope="row">Milano (LIN)- Rodi (RHO)</th>
		  <td>325€</td>
		  <td>250€</td>
		</tr>
		<tr>
		  <th scope="row">Roma (FCO)-Rodi (RHO)</th>
		  <td>295€</td>
		  <td>230€</td>
		</tr>
	  </tbody>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=102" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
</div>
