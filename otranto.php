...
<div class="col-sm-12">
	<h1 id="presentazione" class="text-center">Otranto a soli 450,00€ a persona
...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/otranto2.jpg"/> </div>
			<div class="item"><img src="img/otranto3.jpg"/> </div>
			<div class="item"><img src="img/otranto4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="col-sm-12">
<div id="container">
	<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-g652004-d1133671-Reviews-Corte_di_Nettuno-Otranto_Province_of_Lecce_Puglia.html"><b><i>Hotel Corte di Nettuno Otranto</i></b> - Via Madonna del Passo, 73028 OTRANTO (LE)</a></p>
	<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> 0836 801832 - <span class="glyphicon glyphicon-envelope" style="color:orange"></span>sunshinehotel@gmail.com</p>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=99" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
</div>
