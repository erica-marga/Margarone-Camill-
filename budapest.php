...
<div class="container">
	<div class="jumbotron">
		...
		<div class="row">
			<div class="col-sm-12">
				<h1 id="presentazione" class="text-center">Budapest a soli 350,00€ a persona
...
<div id="carousel"  class="carousel slide" data-ride="carousel"> 
	<!-- indicatori -->
		...
		<div class="item active"><img src="img/budapest2.jpg"/> </div>
			<div class="item"><img src="img/budapest3.jpg"/> </div>
			<div class="item"><img src="img/budapest4.jpg"/> </div>
			<div class="item"><img src="img/budapest5.jpg"/> </div>
			<div class="item"><img src="img/budapest.jpg"/> </div>
			</div> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">	
		<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-s1-g274887-d309857-Reviews-Danubius_Hotel_Astoria_City_Center-Budapest_Central_Hungary.html"><b><i>Danubius Hotel Astoria</i></b> - Budapest, Kossuth Lajos u. 19, 1053 Ungheria</a></p>
			<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +36 1 889 6000<span class="glyphicon glyphicon-envelope" style="color:orange"></span>sunshinehotel@gmail.com</p>
			<p id="info" class="text-left"> <span class="glyphicon glyphicon-home"></span> Hotel 3 <span class="glyphicon glyphicon-star" style="color:yellow"></span></p>
	...
	<h1 id="promozione" class="text-center">Il prezzo include:</h1>
		<div id="pacchetto" class="text-left">
			<p><b> Volo:</b>
				<div id="info"> 
				<p ><span class="glyphicon glyphicon-plane"></span> Andata:</P>
				<p id="info">lun 18 sett. Roma Fiumicino (FCO)</p>
				<p id="info">Operato da: <b>Wizz Air</b></p>
				<p><span class="glyphicon glyphicon-plane"></span> Ritorno:</p>
				<p id="info">lun 25 sett. Budapest (BUD)</p>
				<p id="info">Operato da:<b> Wizz Air</b></p>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=119" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
</div>
