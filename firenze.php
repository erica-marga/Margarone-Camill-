...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/firenze2.jpg"/> </div>
			<div class="item"><img src="img/firenze3.jpg"/> </div>
			<div class="item"><img src="img/firenze4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">
		<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-s1-g187895-d195406-Reviews-Grand_Hotel_Cavour-Florence_Tuscany.html"><b><i>Grand Hotel Cavour</i></b></a></p>
		<p id="promozione" class="text-center">Via Del Proconsolo 3 Florence (FI)</p>
		<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +39 800 871 698 </p>
		<br>
		<div class="col-sx-12">
		<p id="info" class="text-justify">Questo hotel si trova a 150 metri dal Museo del Bargello e a 250 metri dalla Casa di Dante, da Piazza del Duomo e dalla Badia Fiorentina.Il Museo dell'Opera del Duomo dista 300 metri. La Terrazza panoramica sull'attico con bar del Grand Hotel Cavour si affaccia sulla Cattedrale di Santa Maria del Fiore. </p>
		</div>
		<p id="promozione" class="text-center">Il prezzo include:</p>
		<p id="info" class="text-justify"><span class="glyphicon glyphicon-bed"></span>  Una camera per 2 adulti | Numero notti: 6
		...
		<p id="info" class="text-left"><span class="glyphicon-glyphicon-comment"></span>Lingue straniere:francese, inglese, spagnolo
...
<div class="jumbotron">
	<div class="container">
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=104" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
