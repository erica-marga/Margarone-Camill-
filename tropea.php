...
<div class="col-sm-12">
	<h1 id="presentazione" class="text-center">Tropea a soli 250,00€ a persona
...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/tropea2.jpg"/> </div>
			<div class="item"><img src="img/tropea3.jpg"/> </div>
			<div class="item"><img src="img/tropea1.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="col-sm-12">
<div id="container">
	<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-g194939-d1748598-Reviews-Hotel_Rocca_Della_Sena-Tropea_Province_of_Vibo_Valentia_Calabria.html"><b><i>Hotel Rocca Della Sena</i></b> - Via Paolo Orsi | Contrada Croce, 89861 Tropea</a></p>
	<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> 0963/554789  <span class="glyphicon glyphicon-envelope" style="color:orange"></span>sunshinehotel@gmail.com</p>
	...
	<p id="info">lun 25 sett. Lamezia Terme (SUF)</p>
	<p id="info">Operato da:<b> Alitalia</b></p>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=98" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
