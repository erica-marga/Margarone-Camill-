...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/alpin3.jpg"/> </div>
			<div class="item"><img src="img/alpin2.jpg"/> </div>
			<div class="item"><img src="img/alpin4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">
		<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-g950383-d597139-Reviews-Alpin_Royal_Wellness_and_Resort-San_Giovanni_in_Valle_Aurina_Province_of_South_Tyrol_Tr.html"><b><i>Alpin Royal </i></b>- Valle Aurina | Alto Adige</a></p>
		...
		<ul>
			<li>4 pernottamenti con trattamento Royal inclusive e utilizzo della nostra area Wellness & Spa</li>
			<li>Ingresso a Castel Tures – uno dei più imponenti castelli dell’Alto Adige</li>
			<li>Escursione guidata attraverso la Valle Aurina con sosta per una merenda</li>
			<li>Buono beauty per un importo di € 50 a camera</li>
		</ul>
<br>
...
<div class="jumbotron">
	<div class="container">
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=126" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
