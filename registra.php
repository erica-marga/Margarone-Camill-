...
<h3><span class="label label-default">REGISTRAZIONE NUOVO UTENTE</span></h3>
    <form class="form-horizontal" action="nuovoutente.php" method="post">
	   <div class="form-group">
		...
		<div class="form-group">
            <label class="control-label col-xs-3" for="password">Conferma Password*</label>
            <div class="col-xs-9">
                <input type="password" name="password" class="form-control" id="password" placeholder="password">
            </div>
        </div>
		...
		<div class="form-group">
            ...
            <div class="col-xs-9">
                <input type="date" name="datanascita" class="form-control" id="datanascita" placeholder="Data di nascita">
            </div>
        </div>
        <br>
        <div class="form-group">
