...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/zurigo2.jpg"/> </div>
			<div class="item"><img src="img/zurigo3.jpg"/> </div>
			<div class="item"><img src="img/zurigo4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="container">
	<div class="col-sm-12">
	<div id="container">
		<p id="promozione" class="text-center"> <b><i>Hotel Glockenhof</i></b></p>
		<p id="promozione" class="text-center">Sihlstrasse 31, Zurigo 8001, Svizzera</p>
		<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +39 800 871 698 </p>
		<br>
		<div class="col-sx-12">
		<p id="info" class="text-justify">Situato accanto alla via centrale dello shopping Bahnhofstrasse, a 500 m dalla stazione centrale di Zurigo.Le eleganti camere dispongono di pavimenti in legno, fax e bagni moderni con pareti in vetro, accappatoi e pantofole. Dotato di un tranquillo giardino terrazzato, l'Hotel Glockenhof Zürich ospita 2 ristoranti che servono cucina internazionale, raffinate specialità svizzere e piatti vegetariani. Al bar vi attende un drink di benvenuto in omaggio. </p>
		</div>
...
<div class="jumbotron">
	<div class="container">
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=106" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>			
