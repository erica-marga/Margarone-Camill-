...
<div class="col-sm-12">
	<h1 id="presentazione" class="text-center">Zagabria a soli 350,00€ a persona
...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/zagabria2.jpg"/> </div>
			<div class="item"><img src="img/zagabria3.jpg"/> </div>
			<div class="item"><img src="img/zagabria4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="col-sm-12">
<div id="container">
	<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-s1-g294454-d601893-Reviews-Hotel_Tomislavov_dom-Zagreb_Central_Croatia.html"><b><i>Hotel Tomislavov dom</i></b> - Sljeme bb, 10000, Zagreb, Croazia</a></p> 
	<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> +385 1 4560 400 </p>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=103" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>
	</div>
