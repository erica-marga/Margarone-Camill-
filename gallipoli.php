...
<div class="col-sm-12">
	<h1 id="presentazione" class="text-center">Gallipoli a soli 400,00€ a persona
...
<div class="container">
	...
	<!-- indicatori -->
		...
		<!-- inserisci le foto per la gallaeria-->
			 <div class="item active"><img src="img/gallipoli1.jpg"/> </div>
			<div class="item"><img src="img/gallipoli3.jpg"/> </div>
			<div class="item"><img src="img/gallipoli4.jpg"/> </div>
		</div>
			<!-- i controlli --> 
...
<div class="col-sm-12">
<div id="container">
	<p id="promozione" class="text-center"><a href="https://www.tripadvisor.it/Hotel_Review-g616185-d310492-Reviews-Hotel_Palazzo_del_Corso-Gallipoli_Province_of_Lecce_Puglia.html"><b><i>Palazzo del Corso</i></b> - Corso Roma, 145 Gallipoli (LE)</a></p>
	<p id="info" class="text-center"><span class="glyphicon glyphicon-phone-alt" style="color:blue"></span> 0836/554789 </p>
	...
	<p id="info" class="text-left"> <span class="glyphicon glyphicon-bed"></span> Camera matrimoniale</p>
	<p id="info" class="text-left"> <span class="glyphicon glyphicon-cutlery"></span> Colazione inclusa</p>
	<p id="info" class="text-left"> <span class="glyphicon glyphicon-car"></span> Parcheggio coperto</p>
	<h1 id="promozione" class="text-center">Il prezzo include:</h1>
	<p id="volo" class="text-left"><b> Volo:</b>
	<p id="info" class="text-left"><span class="glyphicon glyphicon-plane"></span> Volo Andata e Ritorno</p>
	<table class="table table-inverse">
	  ...
	  <tbody>
		<tr>
		  <th scope="row">Milano (LIN)- Bari (RHO)</th>
		  <td>325€</td>
		  <td>250€</td>
		</tr>
		<tr>
		  <th scope="row">Roma (FCO)-Brindisi (RHO)</th>
		  <td>295€</td>
		  <td>230€</td>
		</tr>
	  </tbody>
	</table>
	<p id="info" class="text-left">Operato da: <b>Alitalia</b></p>
...
<div class="jumbotron">
		...
		<div class="row voffset4">
			<a href="prenotazioni.php?camera=100" class="btn btn-primary btn-lg active">Prenota</a>
		</div>
	</div>
</div>		
</div>
